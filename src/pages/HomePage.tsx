...
export function HomePage({ issues }: { issues: Issue[] }) {
  return (
    ...
    >
      <section className="relative overflow-hidden rounded-3xl border border-red-100 bg-gradient-to-br from-white via-red-50 to-orange-50 p-8 shadow-lg sm:p-12">
        ...
        <div className="relative max-w-2xl space-y-5">
          ...
          <Button asChild className="h-11 rounded-xl bg-red-500 px-6 text-white hover:bg-red-600 sm:w-auto">
